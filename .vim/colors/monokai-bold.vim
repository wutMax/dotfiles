...
let s:grey        = { "gui": "#b2b2b2", "cterm": "249" }
...
let s:green2 	  = { "gui": "#5fd75f", "cterm": "77" }	
...
call s:h("Cursor",        { "fg": s:purple,      "bg": s:white })
...
call s:h("Comment",       { "fg": s:green2, "format": "italic" })
